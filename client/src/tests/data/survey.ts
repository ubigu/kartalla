...
export const createMockTextSection = (id: number): SurveyTextSection => ({
  id,
  type: 'text',
  title: { fi: 'Otsikko', en: 'Title', se: '' },
  body: { fi: 'Tekstiä', en: 'Some text', se: '' },
  bodyColor: '#000000',
});
...
export const createMockRadioQuestion = (id: number): SurveyRadioQuestion => ({
  id,
  type: 'radio',
  title: { fi: 'Kysymys', en: 'Question', se: '' },
  isRequired: false,
  allowCustomAnswer: false,
  options: [
    {
      text: { fi: 'Vaihtoehto 1', en: 'Option 1', se: '' },
      info: { fi: 'Lisätieto', en: 'Info', se: '' },
    },
    {
      text: { fi: 'Vaihtoehto 2', en: 'Option 2', se: '' },
    },
  ],
});
