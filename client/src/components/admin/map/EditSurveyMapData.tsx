...
import { SurveyMapProvider } from '@interfaces/survey';
    ...
    >
      ...
      <Select<SurveyMapProvider>
        ...
        options={[
          {
            value: 'openlayers',
            label: tr.EditSurveyInfo.mapProviderOpenlayers,
          },
          { value: 'oskari', label: tr.EditSurveyInfo.mapProviderOskari },
        ]}
      />
      {activeSurvey.mapProvider === 'oskari' && (
        <>
          ...
          <Input
            ...
            {...(validationErrors?.includes('survey.mapUrl') && {
              helperText: tr.EditSurveyInfo.mapUrlError,
            })}
          />
          {availableMapLayersLoading && (
